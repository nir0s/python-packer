...
# -*- coding: utf-8 -*-
#
# python-packer documentation build configuration file, created by
...
#     print 'To build the documentation, The distribution information of {0}'.format(project)
